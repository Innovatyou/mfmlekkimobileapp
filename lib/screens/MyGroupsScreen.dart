...
class MyGroupsScreen extends StatefulWidget {
  static const routeName = "/MyGroupsScreen";
  MyGroupsScreen();
...
class PrayersScreenRouteState extends State<MyGroupsScreen> {
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => GroupsScreensModel(ApiUrl.FETCH_MY_GROUPS),
      child: Scaffold(
        appBar: AppBar(
          title: Text(t.groupsibelongto),
        ),
        body: Padding(
...
class ItemTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // DashboardModel dashboardModel = Provider.of<DashboardModel>(context); // unused
    return Padding(
